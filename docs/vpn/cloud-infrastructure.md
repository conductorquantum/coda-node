...
This means two different bootstrap attempts for the same QPU (e.g.
...
- VPN credentials are **never stored in bootstrap tokens** — they are
  provisioned at connect time only.
